...
module.exports = {
  ...
  checkintitle: () => "CCCAT", //填写签到标题
  checkinloginurl: () => "https://cccat.io/user/login.php", //填写签到登陆链接
  checkinemail: () => "877820030@qq.com", //填写签到邮箱
  checkinpwd: () => "wangzhao1989", //填写签到密码
  apps: () => [
    "1443988620|hk",
    "1312014438 cn",
    "499470113/vn",
  ...
  lastnumberofcar: () => "7" //北京尾号限行脚本填写汽车尾号
};
